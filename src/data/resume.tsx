...
export const DATA = {
  ...
  //     active: true,
  //     description:
  //       "We made a customized management app for Chamber Fitness , Permanagalam , with attendance tracking and reports , membership management and automated notifications , Expense and income management",
  //     technologies: [
  //       "Next.js",
  //       "Typescript",
  //       "PostgreSQL",
  ...
  //     active: true,
  //     description:
  //       "It is a digital marketing and event planning web application , used by digital marketing agencies to scedule task to creators and editors , manage billing and event scheduling attendance tracking of staff etc.",
  //     technologies: [
  //       "Next.js",
  //       "Typescript",
  //       "PostgreSQL",
  ...
  projects: [
    {
      ...
      technologies: ["Next.js", "JavaScript", "TailwindCSS", "TensorFlow", "OpenAI API"],
      links: [
        {
          type: "Source",
          href: "https://github.com/SAIKRISHNA2005/caption-generator",
    ...
    },
    {
      ...
      active: true,
      description: "A healthcare management system for patient records, appointment scheduling, and secure doctor-patient communication.",
      technologies: ["Next.js", "TypeScript", "TailwindCSS", "Appwrite", "Node.js", "MongoDB"],
      links: [
        {
          type: "Source",
          href: "https://github.com/SAIKRISHNA2005/health-care",
    ...
    },
    {
      ...
      active: true,
      description: "A fintech app offering secure fund transfers, account management, and real-time transaction tracking with encrypted security.",
      technologies: ["Next.js", "TypeScript", "TailwindCSS", "Appwrite", "Node.js", "PostgreSQL"],
      links: [
        {
          type: "Source",
          href: "https://github.com/SAIKRISHNA2005/banking",
